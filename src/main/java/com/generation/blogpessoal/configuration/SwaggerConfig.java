	...
	OpenAPI springBlogPessoalOpenAPI() {
		return new OpenAPI()
				.info(new Info().title("Projeto Blog Pessoal").description("Projeto Blog Pessoal - Generation Brasil")
						...
						.contact(new Contact().name("Luan Lazarine").url("https://github.com/Lazarine1996")
								.email("luanlazarine@gmail.com")))
				.externalDocs(
						new ExternalDocumentation().description("GitHub").url("https://github.com/Lazarine1996/"));
	}
